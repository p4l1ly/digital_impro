...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Preview = __webpack_require__(207);
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactRouterDom.Route, { path: '/preview/:id', component: _Preview2.default })
	    )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ConfigsList = __webpack_require__(209);

	var _ConfigsList2 = _interopRequireDefault(_ConfigsList);

	var _ConfigFileInput = __webpack_require__(210);

	var _ConfigFileInput2 = _interopRequireDefault(_ConfigFileInput);
	...
	var Config = function (_Component) {
	    ...
	    _createClass(Config, [{
	        ...
	        key: "onAdd",
	        value: function onAdd(cnf) {
	            this.setState({
	                configs: [].concat(_toConsumableArray(this.state.configs), [{ filename: 'heeey.hs' }])
	            });
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_ConfigsList2.default, { configs: this.state.configs }),
	                _react2.default.createElement(_ConfigFileInput2.default, { onAdd: this.onAdd.bind(this) })
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ConfigsList = function (_Component) {
	    _inherits(ConfigsList, _Component);

	    function ConfigsList() {
	        _classCallCheck(this, ConfigsList);

	        return _possibleConstructorReturn(this, (ConfigsList.__proto__ || Object.getPrototypeOf(ConfigsList)).apply(this, arguments));
	    }

	    _createClass(ConfigsList, [{
	        key: 'render',
	        value: function render() {
	            var cfgs = this.props.configs.map(function (cfg, i) {
	                return _react2.default.createElement(
	                    'div',
	                    { key: 'config-' + i, className: 'config-file' },
	                    _react2.default.createElement(
	                        'b',
	                        null,
	                        cfg.filename
	                    ...
	                    _react2.default.createElement('input', { type: 'radio', name: 'config-file', id: 'config-' + i })
	                );
	            });
	            return _react2.default.createElement(
	                'div',
	                { className: 'configs-list' },
	                cfgs
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ConfigFileInput = function (_Component) {
	    _inherits(ConfigFileInput, _Component);

	    function ConfigFileInput() {
	        _classCallCheck(this, ConfigFileInput);

	        return _possibleConstructorReturn(this, (ConfigFileInput.__proto__ || Object.getPrototypeOf(ConfigFileInput)).apply(this, arguments));
	    }

	    _createClass(ConfigFileInput, [{
	        key: "handleSubmit",
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                "form",
	                { onSubmit: this.handleSubmit.bind(this), datatype: "multipart/form-data" },
	                _react2.default.createElement(
	                    "label",
	                    null,
	                    "Select config file: "
	                ),
	                _react2.default.createElement("input", { type: "file", id: "config-file-input", ref: function ref(fileInput) {
	...
	exports.default = ConfigFileInput;
